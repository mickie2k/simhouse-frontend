          ...
          <nav className="flex flex-col gap-2">
            {menuItems.map((item) => (
              <button
                ...
                className={`text-left px-4 py-3 rounded-xl transition-all duration-200 flex items-center justify-between ${activeSection === item.id
        ...
        <div className="max-w-3xl">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Describe simulator details..."
                  />
                </div>
          ...
          <div className="mt-8 flex justify-end gap-3 pb-20 md:pb-0">
            ...
            <button
              ...
              className={`px-10 py-3.5 rounded-2xl text-sm font-bold text-white transition-all shadow-lg ${isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-black hover:bg-gray-800 hover:-translate-y-1 hover:shadow-xl'
                }`}
            >
