                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        {simulators.map((sim, index) => {
                            ...
                            return (
                                <Link
                                    href={`/hosting/simulator/${simId}`}
                                    key={simId || index}
                                    className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:scale-105 transition flex flex-col h-[320px] cursor-pointer"
                                >
